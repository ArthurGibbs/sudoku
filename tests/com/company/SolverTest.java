...
public class SolverTest {
  ...
  public void canFinishRow(){
    ...
    assertThat(result.getCell(8, 0).getValue(), is(9));
  }
  ...
  public void canFinishCol() {
    ...
    System.out.println("Expected:\n" + expected);
    System.out.println("Got:\n" + result.getBoardString());
    assertThat(result.getCell(0, 5).getValue(), is(6));
  }
  ...
  public void canFinishBox() {
    ...
    System.out.println("Expected:\n" + expected);
    System.out.println("Got:\n" + result.getBoardString());
    assertThat(result.getCell(1, 2).getValue(), is(8));
  }
  ...
  public void canChainSolves() {
    ...
    System.out.println("Expected:\n" + expected);
    System.out.println("Got:\n" + result.getBoardString());
    assertThat(result.getCell(0, 0).getValue(), is(1));
  }
